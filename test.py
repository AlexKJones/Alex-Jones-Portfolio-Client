...
class MyGame(arcade.Window):
    def __init__(self):
        ...
        #setup list to keep track of things
        self.coin_list = None
        self.wall_list = None
    ...
    def setup(self, level):
        """fuction for restart game"""
        
        # Used to keep track of our scrolling
        self.view_bottom = 0
        self.view_left = 0
        
        # Keep track of score_
        self.score = 0
        ...
        # Set up the player, starting coordinates.
    ...
    def on_draw(self):
        ...
        arcade.draw_text(score_text, 10 + self.view_left, 610 + self.view_bottom,
                         arcade.csscolor.MEDIUM_BLUE, 18)
